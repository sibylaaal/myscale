...
<div className="">
  ...
  <div className="px-4 md:px-10 py-4 md:py-7">
    <div className="flex items-center justify-between">
      ...
      <div className="py-3 px-4 flex items-center text-sm font-medium leading-none text-gray-600 bg-gray-200 hover:bg-gray-300 cursor-pointer rounded">
        ...
        <select
          aria-label="select"
          className="focus:text-cyan-600 focus:outline-none bg-transparent ml-1"
        >
  ...
  <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
    <div className="sm:flex items-center justify-between">
      ...
      <button
      onClick={()=>navigate("/user/pulling")}
        className="focus:ring-2 focus:ring-offset-2 bg-cyan-600 focus:ring-cyan-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3  hover:bg-cyan-600 focus:outline-none rounded"
      >
      ...
      <table className="w-full whitespace-nowrap">
        <tbody>
            ...
            <td>
              <div className="relative px-5 pt-2">
                ...
                <div className="dropdown-content bg-white shadow w-24 absolute z-30 right-0 mr-6 hidden">
                  <div
                    tabIndex={0}
                    className="focus:outline-none focus:text-cyan-600 text-xs w-full hover:bg-indigo-700 py-4 px-4 cursor-pointer hover:text-white"
                  >
                    <p>Edit</p>
                  </div>
                  <div
          ...
          >
            ...
            <td className="focus:text-cyan-600 ">
              <div className="flex items-center pl-5">
                <p className="text-base font-medium leading-none text-gray-700 mr-2">
                  UX Wireframes
                </p>
          ...
          <tr
            tabIndex={0}
            className="focus:outline-none focus:text-cyan-600 h-16 border border-gray-100 rounded"
          >
            <td>
              <div className="ml-5">
                <div className="bg-gray-200 rounded-sm w-5 h-5 flex flex-shrink-0 justify-center items-center relative">
